...
Teams selecting neoantigens for personalized vaccines run several prediction tools — NetMHCpan, MHCflurry, BigMHC, PRIME — and routinely get conflicting scores. Reconciling them is manual, inconsistent, and rarely documented. This pipeline synthesizes multiple orthogonal signals into a single ranked, reasoned, auditable output.
